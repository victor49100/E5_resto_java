...
public class TestAdministrateur_JPA {
     public static void main(String[] args) {
        Administrateur admin = new Administrateur(Long.MIN_VALUE, "test@test.com", "secret", "Admin1");
        Administrateur admin2 = new Administrateur(Long.MIN_VALUE, "test@test.com", "secret2", "Admin2");
