 ...
 * @author acassard
 */
public class VueResponsable extends javax.swing.JFrame {

    /**
     * Creates new form VueResponsable
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VueResponsable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VueResponsable().setVisible(true);
            }
        });
    }
