...
@NamedQueries({
    ...
    @NamedQuery(name = "Critiquer.findByIdRAndIdU", query = "SELECT c FROM Critiquer c WHERE c.critiquerPK.idR =:idR AND c.critiquerPK.idU = :idU")})
public class Critiquer implements Serializable {
    ...
    public String toString() {
        return "Critiquer{" + "critiquerPK=" + critiquerPK + ", note=" + note + ", commentaire=" + commentaire + ", resto=" + resto + ", utilisateur=" + utilisateur + '}';
    }
